...
// const ohMy = axios.get('http://localhost:3000/animals').then(response, function(){
...
// const repeatMyParam = axios.get('http://localhost:3000/repeat/' + 'str').then(response, function(){
//     console.log(response.data)
// })

// return axios.get('http://localhost:3000/repeat/')
// .then(res => res.data)
...
axios.get('http://localhost:3000/query-test?query-one&query-two')
